...
<head>
  ...
  <title><?php echo $title_web;?> | Sistem Informasi Perpustakaan SMKN 2 Sumbawa Besar </title>
...
<div class="wrapper">
  <header class="main-header">
    ...
    <!-- Logo -->
    <a href="<?php echo base_url('index.php/dashboard');?>" class="logo" style="display: flex; align-items: center; height: 60px;">
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg" style="display: flex; align-items: center;">
        <img src="assets_style/image/SMKN2.png" alt="Logo" style="height: 40px; margin-right: 30px;">
        <span style="font-size: 10px;">SMKN 2 SUMBAWA BESAR</span>
     </span>
    </a>
