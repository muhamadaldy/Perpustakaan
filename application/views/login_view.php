...
<body class="hold-transition login-page" style="overflow-y: hidden;background:url(
	'<?php echo base_url('assets_style/image/STM.jpeg');?>')no-repeat;background-size:100%;">
<div class="login-box">
	<br/>
  <div class="login-logo">
    <a href="index.php" style="color: black;"><b>Sistem Informasi</b> <br/><b>Perpustakaan SMKN 2 Sumbawa Besar</b></a>
  </div>
  ...
  <footer>
    <div class="login-box-body text-center bg-blue">
       <a style="color: yellow;"> By aldy64777@gmail.com ; Sistem Perpustakaan SMKN 2 Sumbawa Besar - <?php echo date("Y");?>
    </div>
  </footer>
</div>
<!-- /.login-box -->
